...
WORKSPACE = Path(r"C:\n8n automation")
BACKUP_PATH = WORKSPACE / "voice-assistant-before-pollinations-labels-patch.json"
EXPORT_PATH = WORKSPACE / "voice-assistant-pollinations-labels-export.json"

RENAMES = {
    "Build Gemini Intent Request": "Build Pollinations GPT-5 Mini Request",
    "Gemini 2.5 Flash - Process Intent": "Pollinations GPT-5 Mini - General LLM",
}
...
def main() -> None:
    ...
    print("Renamed intent nodes to Pollinations GPT-5 Mini labels")
